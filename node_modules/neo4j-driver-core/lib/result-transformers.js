...
var ResultTransformers = /** @class */ (function () {
    ...
    ResultTransformers.prototype.hydrated = function (constructorOrRules, rules) {
        var _this = this;
        return function (result) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, result.as(constructorOrRules, rules).then()];
