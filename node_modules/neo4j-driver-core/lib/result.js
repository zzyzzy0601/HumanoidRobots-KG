...
var GenericResult = /** @class */ (function () {
    ...
    GenericResult.prototype.as = function (constructorOrRules, rules) {
        ...
        // @ts-expect-error
        this._mapper = function (r) { return r.as(constructorOrRules, rules); };
        // @ts-expect-error
        return this;
    };
    /**
    ...
    GenericResult.prototype._createQueuedResultObserver = function (onQueueSizeChanged) {
        ...
        var observer = {
            onNext: function (record) {
                if (_this._mapper != null) {
                    observer._push({ done: false, value: _this._mapper(record) });
                }
                else {
 ...
 * @access public
 */
var MappedResult = /** @class */ (function (_super) {
