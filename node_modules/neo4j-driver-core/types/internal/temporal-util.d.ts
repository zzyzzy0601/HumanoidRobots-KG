...
export declare function normalizeYearsForDuration(months: NumberOrInteger | string): Integer;
export declare function normalizeMonthsForDuration(months: NumberOrInteger | string): Integer;
export declare function normalizeHoursForDuration(seconds: NumberOrInteger | string, nanoseconds: NumberOrInteger | string): Integer;
export declare function normalizeMinutesForDuration(seconds: NumberOrInteger | string, nanoseconds: NumberOrInteger | string): Integer;
export declare function normalizeSecondsForDuration(seconds: NumberOrInteger | string, nanoseconds: NumberOrInteger | string): Integer;
export declare function normalizeNanosecondsForDuration(nanoseconds: NumberOrInteger | string): Integer;
/**
