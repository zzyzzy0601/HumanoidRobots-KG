...
var bolt_protocol_v6x0_transformer_1 = __importDefault(require("./bolt-protocol-v6x0.transformer"));
    ...
    Object.defineProperty(BoltProtocol.prototype, "transformer", {
        get: function () {
            ...
            if (this._transformer === undefined) {
                this._transformer = new transformer_1.default(Object.values(bolt_protocol_v6x0_transformer_1.default).map(function (create) { return create(_this._config, _this._log); }));
            }
